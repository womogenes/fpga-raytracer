// Backup snapshot of the DRAM-enabled top prior to "incremental bring-up" work.
// Taken 2026-02-13.
//
// This file is not referenced by any build scripts; it's here so we can always
// restore the previous DRAM experiment while we iterate in small steps.
